  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-stone-100 selection:bg-stone-200 selection:text-black">
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.08),_transparent_30%),radial-gradient(circle_at_80%_20%,_rgba(180,180,180,0.10),_transparent_22%),linear-gradient(to_bottom,_#0a0a0a,_#111111_35%,_#0a0a0a)]" />
        <div className="absolute inset-0 opacity-[0.06] bg-[linear-gradient(to_right,transparent,rgba(255,255,255,0.35),transparent)] [background-size:1200px_100%]" />
      </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 py-4 md:px-6 md:py-4">
          ...
          <nav
            ...
            className="-mx-1 mt-4 overflow-x-auto pb-1 md:mx-0 md:overflow-visible md:pb-0"
          >
      ...
      <main id="cover" className="relative z-10 scroll-mt-40 md:scroll-mt-44">
        <section
          id="editorial"
          className="scroll-mt-28 mx-auto max-w-7xl px-6 pb-12 pt-16 md:scroll-mt-32 md:pb-20 md:pt-24"
        >
          <div className="grid items-stretch gap-8 lg:grid-cols-12">
            <div className="lg:col-span-8">
              <div className="h-full rounded-[28px] border border-white/10 bg-white/[0.04] p-8 shadow-2xl shadow-black/30 md:p-10">
            ...
            <div className="lg:col-span-4">
              <div className="flex h-full flex-col gap-6">
                <div className="rounded-[28px] border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/30">
                  <div className="text-xs uppercase tracking-[0.3em] text-stone-400">
                    {current.lineLabel}
                  </div>
                  <div className="mt-4 text-2xl leading-tight">{current.lineTitle}</div>
                ...
                <div
                  id="manifesto"
                  className="scroll-mt-44 rounded-[28px] border border-white/10 bg-white/[0.03] p-6 shadow-2xl shadow-black/20 md:scroll-mt-44"
                >
                  <div className="text-xs uppercase tracking-[0.3em] text-stone-400">
                    {current.manifestoLabel}
                  </div>
                  <div className="mt-4 text-2xl leading-tight text-stone-100">
        ...
        <section
          id="feature"
          className="scroll-mt-40 mx-auto max-w-7xl px-6 py-12 md:scroll-mt-44 md:py-20"
        >
          <div className="grid gap-8 lg:grid-cols-12">
            <div className="lg:col-span-3">
              <div className="sticky top-28">
                ...
                <div className="mt-4 text-sm leading-relaxed text-stone-400">
                  {current.featureAside}
                </div>
              </div>
            </div>

            <article className="lg:col-span-9 rounded-[32px] border border-white/10 bg-[#111111] p-8 shadow-2xl shadow-black/40 md:p-12 xl:p-16">
        ...
        <section
          id="theses"
          className="scroll-mt-28 mx-auto max-w-7xl px-6 py-12 md:scroll-mt-32 md:py-16"
        >
          <div className="grid gap-8 lg:grid-cols-12">
            <div className="lg:col-span-3">
              <div className="text-xs uppercase tracking-[0.35em] text-stone-500">
        ...
        <section
          id="future"
          className="scroll-mt-40 mx-auto max-w-7xl px-6 py-12 md:scroll-mt-44 md:py-16"
        >
          <div className="grid gap-8 lg:grid-cols-12">
            <div className="lg:col-span-3">
              <div className="text-xs uppercase tracking-[0.35em] text-stone-500">
            ...
            <div className="lg:col-span-9 grid gap-5 md:grid-cols-2">
              {current.futureIssues.map((issue, idx) => (
                <div
                  key={idx}
                  className="rounded-[28px] border border-white/10 bg-[#121212] p-7 shadow-lg shadow-black/20 transition-transform duration-300 hover:-translate-y-1"
                >
                  <div className="text-sm uppercase tracking-[0.25em] text-stone-500">
                    {current.futureBadge}
                  </div>
        ...
        <section
          id="about"
          className="scroll-mt-28 mx-auto max-w-7xl px-6 pb-24 pt-12 md:scroll-mt-32 md:pb-32 md:pt-16"
        >
